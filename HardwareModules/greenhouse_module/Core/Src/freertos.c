...
uint32_t debugConsoleTasBuffer[ 128 ];
osStaticThreadDef_t debugConsoleTasControlBlock;
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadStaticDef(debugConsole, debugConsoleTask, osPriorityIdle, 0, 128, debugConsoleTasBuffer, &debugConsoleTasControlBlock);
...
/* USER CODE BEGIN Header_debugConsoleTask */
/**
* @brief Function implementing the debugConsole thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_debugConsoleTask */
void debugConsoleTask(void const * argument)
{
